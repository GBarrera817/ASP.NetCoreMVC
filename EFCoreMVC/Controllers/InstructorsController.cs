...
namespace EFCoreMVC.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstMidName,HireDate, LastName, OfficeAsigment")] Instructor instructor, string[] selectedCourses)
        {
